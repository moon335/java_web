...
<link rel="stylesheet" href="/myweb/css/header2.css">
</head>
<body>
	<header>
		<div id="top">
			<div id="logo">
				<a href="loginComplete.jsp"><img alt="대충 로고 파일" src="images/cgv로고.png"></a>
			</div>
			<div id="menu">
				<img alt="카드광고" src="images/카드광고.png">
				<a href="/myweb/userController?action=logout"><img alt="로그아웃" src="images/로그아웃.png"></a>
